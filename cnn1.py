...
from main import extract_feature,emotions,observed_emotions
...
print("🟢 Sample Feature Shape:", x_train[0].shape)
...
if __name__ == "__main__":
    ...
    history = cnn_model.fit(x_train, y_train, epochs=100, batch_size=32, validation_data=(x_test, y_test),class_weight=class_weight_dict)
    ...
    keras.saving.save_model(cnn_model,"cnn_model_1.keras")
